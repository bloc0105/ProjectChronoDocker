...
tk-dev tcl-dev libfreetype6-dev libxi-dev libxmu-dev
...
RUN cmake -S .. -B . -DENABLE_MODULE_IRRLICHT=ON -DENABLE_MODULE_POSTPROCESS=ON -DENABLE_MODULE_CASCADE=ON -DCMAKE_BUILD_TYPE=${BUILD_TYPE}
